...
export const Jeonnam: React.FC<React.SVGProps<SVGGElement>> = (props) => {
  ...
  return (
    <g id="전라남도" {...props}>
      ...
      <path
        ...
        onClick={() => handlePathClick("신안군")}
      />
      <path
        id="진도군"
        className="st0"
        style={{
          fill: selectedImages["진도군"]
            ? `url(#pattern-진도군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("진도군")}
      />
      <path
        id="완도군"
        className="st0"
        style={{
          fill: selectedImages["완도군"]
            ? `url(#pattern-완도군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("완도군")}
      />
      <polygon
        id="장성군"
        className="st0"
        style={{
          fill: selectedImages["장성군"]
            ? `url(#pattern-장성군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("장성군")}
      />
      <path
        id="영광군"
        className="st0"
        style={{
          fill: selectedImages["영광군"]
            ? `url(#pattern-영광군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("영광군")}
      />
      <path
        id="함평군"
        className="st0"
        style={{
          fill: selectedImages["함평군"]
            ? `url(#pattern-함평군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("함평군")}
      />
      <path
        id="무안군"
        className="st0"
        style={{
          fill: selectedImages["무안군"]
            ? `url(#pattern-무안군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("무안군")}
      />
      <path
        id="영암군"
        className="st0"
        style={{
          fill: selectedImages["영암군"]
            ? `url(#pattern-영암군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("영암군")}
      />
      <path
        id="해남군"
        className="st0"
        style={{
          fill: selectedImages["해남군"]
            ? `url(#pattern-해남군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("해남군")}
      />
      <path
        id="강진군"
        className="st0"
        style={{
          fill: selectedImages["강진군"]
            ? `url(#pattern-강진군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("강진군")}
      />
      <path
        id="장흥군"
        className="st0"
        style={{
          fill: selectedImages["장흥군"]
            ? `url(#pattern-장흥군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("장흥군")}
      />
      <polygon
        id="화순군"
        className="st0"
        style={{
          fill: selectedImages["화순군"]
            ? `url(#pattern-화순군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("화순군")}
      />
      <path
        id="보성군"
        className="st0"
        style={{
          fill: selectedImages["보성군"]
            ? `url(#pattern-보성군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("보성군")}
      />
      <path
        id="고흥군"
        className="st0"
        style={{
          fill: selectedImages["고흥군"]
            ? `url(#pattern-고흥군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("고흥군")}
      />
      <polygon
        id="구례군"
        className="st0"
        style={{
          fill: selectedImages["구례군"]
            ? `url(#pattern-구례군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("구례군")}
      />
      <polygon
        id="곡성군"
        className="st0"
        style={{
          fill: selectedImages["곡성군"]
            ? `url(#pattern-곡성군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("곡성군")}
      />
      <polygon
        id="담양군"
        className="st0"
        style={{
          fill: selectedImages["담양군"]
            ? `url(#pattern-담양군)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("담양군")}
      />
      <path
        id="광양시"
        className="st0"
        style={{
          fill: selectedImages["광양시"]
            ? `url(#pattern-광양시)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("광양시")}
      />
      <polygon
        id="나주시"
        className="st0"
        style={{
          fill: selectedImages["나주시"]
            ? `url(#pattern-나주시)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("나주시")}
      />
      <path
        id="순천시"
        className="st0"
        style={{
          fill: selectedImages["순천시"]
            ? `url(#pattern-순천시)`
            : "currentColor",
          cursor: "pointer",
        }}
        ...
        onClick={() => handlePathClick("순천시")}
      />
      <path
        id="여수시"
        className="st0"
        style={{
          fill: selectedImages["여수시"]
            ? `url(#pattern-여수시)`
            : "currentColor",
          cursor: "pointer",
        }}
