...
export const Sejong: React.FC<React.SVGProps<SVGGElement>> = (props) => {
    ...
    return (
        <g id="세종특별자치시" {...props}>
            ...
            <polygon
                ...
                className="st0"
                style={{
                    fill: selectedImages["세종특별자치시"] ? `url(#pattern-세종특별자치시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("세종특별자치시")}
            />
        </g>
    );
}; 