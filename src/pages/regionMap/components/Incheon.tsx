...
export const Incheon: React.FC<React.SVGProps<SVGGElement>> = (props) => {
    ...
    return (
        <g id="인천광역시" {...props}>
            ...
            <path
                ...
                className="st0"
                style={{
                    fill: selectedImages["강화군"] ? `url(#pattern-강화군)` : 'currentColor',
                    cursor: 'pointer'
                }}
            ...
            <polygon
                ...
                className="st0"
                style={{
                    fill: selectedImages["계양구"] ? `url(#pattern-계양구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="124.8,163.1 133.3,164.8 129.8,169 129,173.7 120.2,173.7 123.1,169.2 119.4,164.3"
                onClick={() => handlePathClick("계양구")}
            />
            <polygon
                id="부평구"
                className="st0"
                style={{
                    fill: selectedImages["부평구"] ? `url(#pattern-부평구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="129,173.7 126.8,179.5 129.9,181.9 120,182 120.2,173.7"
                onClick={() => handlePathClick("부평구")}
            />
            <polygon
                id="남동구"
                className="st0"
                style={{
                    fill: selectedImages["남동구"] ? `url(#pattern-남동구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("남동구")}
            />
            <polygon
                id="연수구"
                className="st0"
                style={{
                    fill: selectedImages["연수구"] ? `url(#pattern-연수구)` : 'currentColor',
                    cursor: 'pointer'
                }}
            ...
            <path
                ...
                className="st0"
                style={{
                    fill: selectedImages["옹진군"] ? `url(#pattern-옹진군)` : 'currentColor',
                    cursor: 'pointer'
                }}
