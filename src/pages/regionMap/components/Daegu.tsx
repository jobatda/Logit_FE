...
export const Daegu: React.FC<React.SVGProps<SVGGElement>> = (props) => {
    ...
    return (
        <g id="대구광역시" {...props}>
            ...
            <path
                ...
                className="st0"
                style={{
                    fill: selectedImages["달성군"] ? `url(#pattern-달성군)` : 'currentColor',
                    cursor: 'pointer'
                }}
