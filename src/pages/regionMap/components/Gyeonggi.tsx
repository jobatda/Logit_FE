...
export const Gyeonggi: React.FC<React.SVGProps<SVGGElement>> = (props) => {
    ...
    return (
        <g id="경기도" {...props}>
            ...
            <polygon
                ...
                className="st0"
                style={{
                    fill: selectedImages["양평군"] ? `url(#pattern-양평군)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("양평군")}
            />
            <polygon
                id="가평군"
                className="st0"
                style={{
                    fill: selectedImages["가평군"] ? `url(#pattern-가평군)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("가평군")}
            />
            <path
                id="연천군"
                className="st0"
                style={{
                    fill: selectedImages["연천군"] ? `url(#pattern-연천군)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("연천군")}
            />
            <polygon
                id="여주시"
                className="st0"
                style={{
                    fill: selectedImages["여주시"] ? `url(#pattern-여주시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("여주시")}
            />
            <polygon
                id="포천시"
                className="st0"
                style={{
                    fill: selectedImages["포천시"] ? `url(#pattern-포천시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("포천시")}
            />
            <polygon
                id="양주시"
                className="st0"
                style={{
                    fill: selectedImages["양주시"] ? `url(#pattern-양주시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("양주시")}
            />
            <polygon
                id="광주시"
                className="st0"
                style={{
                    fill: selectedImages["광주시"] ? `url(#pattern-광주시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("광주시")}
            />
            <path
                id="화성시"
                className="st0"
                style={{
                    fill: selectedImages["화성시"] ? `url(#pattern-화성시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("화성시")}
            />
            <path
                id="김포시"
                className="st0"
                style={{
                    fill: selectedImages["김포시"] ? `url(#pattern-김포시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("김포시")}
            />
            <polygon
                id="안성시"
                className="st0"
                style={{
                    fill: selectedImages["안성시"] ? `url(#pattern-안성시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("안성시")}
            />
            <polygon
                id="이천시"
                className="st0"
                style={{
                    fill: selectedImages["이천시"] ? `url(#pattern-이천시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("이천시")}
            />
            <path
                id="파주시"
                className="st0"
                style={{
                    fill: selectedImages["파주시"] ? `url(#pattern-파주시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("파주시")}
            />
            <polygon
                id="용인시_수지구"
                className="st0"
                style={{
                    fill: selectedImages["용인시_수지구"] ? `url(#pattern-용인시_수지구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="162.3,197.7 172.5,203.7 176,202.8 176.5,203.3 175.9,205.3 171.1,205.6 169.9,209.3 163.7,205.7 163.7,205.5 161,201"
                onClick={() => handlePathClick("용인시_수지구")}
            />
            <polygon
                id="용인시_기흥구"
                className="st0"
                style={{
                    fill: selectedImages["용인시_기흥구"] ? `url(#pattern-용인시_기흥구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="167,218.4 169.9,209.3 171.1,205.6 175.9,205.3 180.8,211.9 177.5,221.6 169.8,222.1"
                onClick={() => handlePathClick("용인시_기흥구")}
            />
            <polygon
                id="하남시"
                className="st0"
                style={{
                    fill: selectedImages["하남시"] ? `url(#pattern-하남시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("하남시")}
            />
            <polygon
                id="의왕시"
                className="st0"
                style={{
                    fill: selectedImages["의왕시"] ? `url(#pattern-의왕시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="164.1,190.9 164.2,192.8 162.3,197.7 161,201 155.2,204 153.8,208.6 150.3,208.5 150,207.8 154,199.3 156.6,193.2"
                onClick={() => handlePathClick("의왕시")}
            />
            <polygon
                id="군포시"
                className="st0"
                style={{
                    fill: selectedImages["군포시"] ? `url(#pattern-군포시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="150,207.8 143,205.6 145.8,199.6 148.6,196.8 148.7,196.9 151.5,196.6 154,199.3"
                onClick={() => handlePathClick("군포시")}
            />
            <path
                id="시흥시"
                className="st0"
                style={{
                    fill: selectedImages["시흥시"] ? `url(#pattern-시흥시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("시흥시")}
            />
            <polygon
                id="오산시"
                className="st0"
                style={{
                    fill: selectedImages["오산시"] ? `url(#pattern-오산시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="162.5,233.3 158,228.4 162,224.5 166.7,224.8 171.5,233.5 168.5,236.3 163.1,234.6"
                onClick={() => handlePathClick("오산시")}
            />
            <polygon
                id="남양주시"
                className="st0"
                style={{
                    fill: selectedImages["남양주시"] ? `url(#pattern-남양주시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("남양주시")}
            />
            <polygon
                id="과천시"
                className="st0"
                style={{
                    fill: selectedImages["과천시"] ? `url(#pattern-과천시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="157.4,184.2 163.2,183.3 164.7,188.6 164.1,190.9 156.6,193.2 154.3,186.9"
                onClick={() => handlePathClick("과천시")}
            />
            <polygon
                id="고양시_일산서구"
                className="st0"
                style={{
                    fill: selectedImages["고양시_일산서구"] ? `url(#pattern-고양시_일산서구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="118.5,146.1 130.9,145.6 130.7,150.8 125.7,154.4 118.7,150.3"
                onClick={() => handlePathClick("고양시_일산서구")}
            />
            <polygon
                id="고양시_일산동구"
                className="st0"
                style={{
                    fill: selectedImages["고양시_일산동구"] ? `url(#pattern-고양시_일산동구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="125.7,154.4 130.7,150.8 130.9,145.6 134.1,140.5 138.8,142 140.9,148.2 133,157.9 129.1,157.2"
                onClick={() => handlePathClick("고양시_일산동구")}
            />
            <polygon
                id="고양시_덕양구"
                className="st0"
                style={{
                    fill: selectedImages["고양시_덕양구"] ? `url(#pattern-고양시_덕양구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("고양시_덕양구")}
            />
            <polygon
                id="안산시_상록구"
                className="st0"
                style={{
                    fill: selectedImages["안산시_상록구"] ? `url(#pattern-안산시_상록구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("안산시_상록구")}
            />
            <path
                id="평택시"
                className="st0"
                style={{
                    fill: selectedImages["평택시"] ? `url(#pattern-평택시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("평택시")}
            />
            <polygon
                id="광명시"
                className="st0"
                style={{
                    fill: selectedImages["광명시"] ? `url(#pattern-광명시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="138.1,181.1 143.2,179.9 146.2,187.2 143.5,192.9 143.4,192.9 139.7,191.4 137.2,183.9"
                onClick={() => handlePathClick("광명시")}
            />
            <path
                id="부천시"
                className="st0"
                style={{
                    fill: selectedImages["부천시"] ? `url(#pattern-부천시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                d="M137.3,176.2l-1.6,5.3l2.3-0.4l-0.9,2.8l-6-2l-1.3,0l-3.2-2.4l2.3-5.8l0.8-4.7l6.9,2.2L137.3,176.2z"
                onClick={() => handlePathClick("부천시")}
            />
            <polygon
                id="안양시_동안구"
                className="st0"
                style={{
                    fill: selectedImages["안양시_동안구"] ? `url(#pattern-안양시_동안구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="154.3,186.9 156.6,193.2 154,199.3 151.5,196.6 149.7,192 152.4,187.3"
                onClick={() => handlePathClick("안양시_동안구")}
            />
            <polygon
                id="안양시_만안구"
                className="st0"
                style={{
                    fill: selectedImages["안양시_만안구"] ? `url(#pattern-안양시_만안구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                ...
                onClick={() => handlePathClick("안양시_만안구")}
            />
            <polygon
                id="의정부시"
                className="st0"
                style={{
                    fill: selectedImages["의정부시"] ? `url(#pattern-의정부시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="172.2,133.9 174.5,135.1 177.3,137.8 169.1,147.1 165.5,148.7 161,146.2 159.4,136.6"
                onClick={() => handlePathClick("의정부시")}
            />
            <polygon
                id="성남시_분당구"
                className="st0"
                style={{
                    fill: selectedImages["성남시_분당구"] ? `url(#pattern-성남시_분당구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="164.2,192.8 173.7,191 180.5,192.6 176,202.8 172.5,203.7 162.3,197.7"
                onClick={() => handlePathClick("성남시_분당구")}
            />
            <polygon
                id="성남시_중원구"
                className="st0"
                style={{
                    fill: selectedImages["성남시_중원구"] ? `url(#pattern-성남시_중원구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="181.2,181.7 183,189 180.5,192.6 173.7,191 180.8,182.2"
                onClick={() => handlePathClick("성남시_중원구")}
            />
            <polygon
                id="성남시_수정구"
                className="st0"
                style={{
                    fill: selectedImages["성남시_수정구"] ? `url(#pattern-성남시_수정구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="174.3,183 176.8,181.9 180.8,182.2 173.7,191 164.2,192.8 164.1,190.9 164.7,188.6 170.7,184.6"
                onClick={() => handlePathClick("성남시_수정구")}
            />
            <polygon
                id="수원시_영통구"
                className="st0"
                style={{
                    fill: selectedImages["수원시_영통구"] ? `url(#pattern-수원시_영통구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="169.9,209.3 167,218.4 163.4,218.6 163.3,215.8 163,210 163.7,205.7"
                onClick={() => handlePathClick("수원시_영통구")}
            />
            <polygon
                id="수원시_팔달구"
                className="st0"
                style={{
                    fill: selectedImages["수원시_팔달구"] ? `url(#pattern-수원시_팔달구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="163,210 163.3,215.8 156,211.1"
                onClick={() => handlePathClick("수원시_팔달구")}
            />
            <polygon
                id="수원시_권선구"
                className="st0"
                style={{
                    fill: selectedImages["수원시_권선구"] ? `url(#pattern-수원시_권선구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="163.4,218.6 155,220 149.6,212.2 150.3,208.5 153.8,208.6 156,211.1 163.3,215.8"
                onClick={() => handlePathClick("수원시_권선구")}
            />
            <polygon
                id="수원시_장안구"
                className="st0"
                style={{
                    fill: selectedImages["수원시_장안구"] ? `url(#pattern-수원시_장안구)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="161,201 163.7,205.5 163.7,205.5 163.7,205.7 163,210 156,211.1 153.8,208.6 153.8,208.6 155.2,204"
                onClick={() => handlePathClick("수원시_장안구")}
            />
            <polygon
                id="동두천시"
                className="st0"
                style={{
                    fill: selectedImages["동두천시"] ? `url(#pattern-동두천시)` : 'currentColor',
                    cursor: 'pointer'
                }}
                points="172.7,121.4 166.7,120 160.5,110.7 165.4,102.8 170.6,104 177.4,114.6 177.4,118.9"
                onClick={() => handlePathClick("동두천시")}
            />
            <polygon
                id="용인시_처인구"
                className="st0"
                style={{
                    fill: selectedImages["용인시_처인구"] ? `url(#pattern-용인시_처인구)` : 'currentColor',
                    cursor: 'pointer'
                }}
